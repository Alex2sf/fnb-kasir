                ...
                <form :action="editMode ? '{{ url('owner/tables') }}/' + tableId : '{{ route('owner.tables.store') }}'" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" x-model="name" required class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500" placeholder="Contoh: 01 atau VIP-1">
                        </div>
                        <div>
